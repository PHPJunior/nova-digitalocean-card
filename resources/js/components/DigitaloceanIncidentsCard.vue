<template>
    <loading-card :loading="loading" class="px-4 py-4" style="height: 100%;">
        <div class="flex mb-4">
            <h2 class="mr-3 text-base text-80 font-bold">Digitalocean - All Incidents</h2>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getDOIncidents () {
                Nova.request().get('https://s2k7tnzlhrpw.statuspage.io/api/v1/incidents.json').then(response => {
                    this.loading = false
