...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_date_format__ = __webpack_require__(6);
...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('digitalocean-status-card', __webpack_require__(7));
    Vue.component('digitalocean-incidents-card', __webpack_require__(13));
    Vue.component('digitalocean-unresolved-incidents-card', __webpack_require__(22));
});
...
var update = __webpack_require__(1)("e8964e68", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getDOStatus: function getDOStatus() {
            ...
            Nova.request().get('https://s2k7tnzlhrpw.statuspage.io/api/v2/status.json').then(function (response) {
                _this.loading = false;
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("3146179b", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__partials_incident__ = __webpack_require__(3);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getDOIncidents: function getDOIncidents() {
            ...
            Nova.request().get('https://s2k7tnzlhrpw.statuspage.io/api/v2/incidents.json').then(function (response) {
                _this.loading = false;
                _this.data = response.data;
            });
        }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("235f1b57", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("912ec282", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getDOIncidents: function getDOIncidents() {
            ...
            Nova.request().get('https://s2k7tnzlhrpw.statuspage.io/api/v2/incidents/unresolved.json').then(function (response) {
                _this.loading = false;
                _this.data = response.data;
            });
        }
